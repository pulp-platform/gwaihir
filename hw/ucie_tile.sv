...
(
  ...
  localparam int AxiSerialCfgIdxOffset = int'(Ucie0SamIdx) - int'(Ucie0AxiSerialCfgSamIdx);
  localparam int TileCfgIdxOffset = int'(Ucie0SamIdx) - int'(Ucie0TileCfgSamIdx);

  ucie_rule_t [TileCfgIdxOffset:0] tile_addrmap;
