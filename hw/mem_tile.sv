...
#(
  ...
  localparam chimney_cfg_t ChimneyCfg = UseInterleaving ?
    ChimneyMemTileInterleaveCfg : ChimneyDefaultCfg;
  ...
  floo_nw_chimney #(
    ...
    .ChimneyCfgW         (set_ports(ChimneyCfg, 1'b1, 1'b1)),
  ...
  `FLOO_WIDE_AXI_TYPEDEF_ALL_CT(axi_nw_join, axi_nw_join_req_t, axi_nw_join_rsp_t,
                                axi_wide_out_addr_t, nw_join_id_t, axi_wide_out_data_t,
                                axi_wide_out_strb_t, nw_join_user_t, axi_nw_join_size_t)
