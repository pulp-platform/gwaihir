...
$(VCS_BUILD)/compile.sh: $(BENDER_YML) $(BENDER_LOCK) $(HYPER_MODEL) $(HYPER_PADFRAME) | $(VCS_BUILD)
...
$(VCS_BUILD)/gwaihir_top.vcs: $(VCS_BUILD)/compile.sh $(GW_HW_ALL)
	...
	cd $(VCS_BUILD) && $(VCS) -Mlib=$(VCS_BUILD) -Mdir=$(VCS_BUILD) $(VCS_FLAGS_GUI) -o $@ -cpp $(CXX) \
		$(VCS_SDF_FLAGS) $(VCS_FLAGS) $(TB_DUT) $(realpath $(CHS_ROOT))/target/sim/src/elfloader.cpp
